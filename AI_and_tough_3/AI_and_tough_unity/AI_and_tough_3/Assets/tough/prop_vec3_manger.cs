...
public class prop_vec3_manger : MonoBehaviour
{
    ...
    void Start()
    {
        //GameObject aaa =  GameObject.Instantiate(new GameObject()) as GameObject;
        //aaa.AddComponent<prop_vec3_manger>();

        //GameObject aaa = new GameObject("aaa");
        //aaa.AddComponent<prop_vec3_manger>();
    ...
    void Update()
    {
        ...
        else
        {
            ...
            if ((is_first_prop_ok == false) && (Input.touches[0].position.y > 300))
            {
                GameObject.Instantiate(prop_gameobject, camera_z_vec3, Quaternion.identity);
